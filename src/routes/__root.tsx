...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0f1a12" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Selah" },
      ...
      { property: "og:site_name", content: "Selah" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Selah: Pause & Reflect" },
      { name: "twitter:description", content: "A calm, reflective home for Scripture, prayer and Christian media." },
